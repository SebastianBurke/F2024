...
namespace scbH60Store.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public ProductController(IProductAPIService productService, IImageService imageService, IProductValidator productValidator, IProductQueryService productQueryService)
        {
